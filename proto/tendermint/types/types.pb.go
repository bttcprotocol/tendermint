...
type CommitSig struct {
	...
	SideTxResults    []*SideTxResult `protobuf:"bytes,5,rep,name=side_tx_results,json=sideTxResults,proto3" json:"side_tx_results,omitempty"`
}
...
type SideTxResult struct {
	Result SideTxResultType `protobuf:"varint,1,opt,name=result,proto3,enum=tendermint.types.SideTxResultType" json:"result,omitempty"`
...
func (m *SideTxResult) GetResult() SideTxResultType {
	if m != nil {
		return m.Result
	}
...
func (m *SideTxResult) GetSig() []byte {
	if m != nil {
		return m.Sig
	}
	return nil
...
type SideTxResultWithData struct {
	Result *SideTxResult `protobuf:"bytes,1,opt,name=result,proto3" json:"result,omitempty"`
	Data   []byte        `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
}

func (m *SideTxResultWithData) Reset()         { *m = SideTxResultWithData{} }
func (m *SideTxResultWithData) String() string { return proto.CompactTextString(m) }
func (*SideTxResultWithData) ProtoMessage()    {}
func (*SideTxResultWithData) Descriptor() ([]byte, []int) {
	return fileDescriptor_d3a6e55e2345de56, []int{14}
}
func (m *SideTxResultWithData) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SideTxResultWithData) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SideTxResultWithData.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SideTxResultWithData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SideTxResultWithData.Merge(m, src)
}
func (m *SideTxResultWithData) XXX_Size() int {
	return m.Size()
}
func (m *SideTxResultWithData) XXX_DiscardUnknown() {
	xxx_messageInfo_SideTxResultWithData.DiscardUnknown(m)
}

var xxx_messageInfo_SideTxResultWithData proto.InternalMessageInfo

func (m *SideTxResultWithData) GetResult() *SideTxResult {
	if m != nil {
		return m.Result
	}
	return nil
...
func (m *SideTxResultWithData) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
func (m *SideTxResponse) GetResult() SideTxResultType {
	if m != nil {
		return m.Result
	}
	return SideTxResultType_SKIP
...
func (m *SideTxResponse) GetSig() []byte {
	if m != nil {
		return m.Sig
	}
	return nil
...
func (m *SideTxResponse) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// Side tx responses for ABCI
type SideTxResponses struct {
	TxHash []byte           `protobuf:"bytes,1,opt,name=tx_hash,json=txHash,proto3" json:"tx_hash,omitempty"`
	Sigs   []SideTxResponse `protobuf:"bytes,2,rep,name=sigs,proto3" json:"sigs"`
}

func (m *SideTxResponses) Reset()         { *m = SideTxResponses{} }
func (m *SideTxResponses) String() string { return proto.CompactTextString(m) }
func (*SideTxResponses) ProtoMessage()    {}
func (*SideTxResponses) Descriptor() ([]byte, []int) {
	return fileDescriptor_d3a6e55e2345de56, []int{16}
}
func (m *SideTxResponses) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SideTxResponses) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SideTxResponses.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SideTxResponses) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SideTxResponses.Merge(m, src)
}
func (m *SideTxResponses) XXX_Size() int {
	return m.Size()
}
func (m *SideTxResponses) XXX_DiscardUnknown() {
	xxx_messageInfo_SideTxResponses.DiscardUnknown(m)
}

var xxx_messageInfo_SideTxResponses proto.InternalMessageInfo

func (m *SideTxResponses) GetTxHash() []byte {
	if m != nil {
		return m.TxHash
	}
	return nil
...
func (m *SideTxResponses) GetSigs() []SideTxResponse {
	if m != nil {
		return m.Sigs
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("tendermint.types.SideTxResultType", SideTxResultType_name, SideTxResultType_value)
	...
	proto.RegisterType((*SideTxResult)(nil), "tendermint.types.SideTxResult")
	proto.RegisterType((*SideTxResultWithData)(nil), "tendermint.types.SideTxResultWithData")
	proto.RegisterType((*SideTxResponse)(nil), "tendermint.types.SideTxResponse")
	proto.RegisterType((*SideTxResponses)(nil), "tendermint.types.SideTxResponses")
}
...
var fileDescriptor_d3a6e55e2345de56 = []byte{
	...
	,
}
...
func (m *SideTxResultWithData) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SideTxResultWithData) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SideTxResultWithData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SideTxResponses) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SideTxResponses) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SideTxResponses) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SideTxResultWithData) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SideTxResponses) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SideTxResultWithData) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SideTxResultWithData: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SideTxResultWithData: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *SideTxResponses) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SideTxResponses: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SideTxResponses: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.Sigs = append(m.Sigs, SideTxResponse{})
