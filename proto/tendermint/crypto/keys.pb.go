...
type PublicKey_Ethsecp256K1 struct {
	Ethsecp256K1 []byte `protobuf:"bytes,3,opt,name=ethsecp256k1,proto3,oneof" json:"ethsecp256k1,omitempty"`
}

func (*PublicKey_Ed25519) isPublicKey_Sum()      {}
func (*PublicKey_Secp256K1) isPublicKey_Sum()    {}
func (*PublicKey_Ethsecp256K1) isPublicKey_Sum() {}
...
func (m *PublicKey) GetEthsecp256K1() []byte {
	if x, ok := m.GetSum().(*PublicKey_Ethsecp256K1); ok {
		return x.Ethsecp256K1
	}
	return nil
}
...
var fileDescriptor_cb048658b234868c = []byte{
	...
	0x44, 0xd2, 0xf3, 0xd3, 0xf3, 0xc1, 0xb2, 0xfa, 0x20, 0x16, 0x44, 0xa1, 0x52, 0x1d, 0x17, 0x67,
	...
	0x10, 0x12, 0x52, 0xe1, 0xe2, 0x49, 0x2d, 0xc9, 0x40, 0x28, 0x61, 0x86, 0x2a, 0x41, 0x11, 0xb5,
	0xe2, 0x78, 0xb1, 0x40, 0x9e, 0xf1, 0xc5, 0x42, 0x79, 0x46, 0x27, 0x56, 0x2e, 0xe6, 0xe2, 0xd2,
	0x5c, 0xa7, 0xa0, 0x13, 0x8f, 0xe4, 0x18, 0x2f, 0x3c, 0x92, 0x63, 0x7c, 0xf0, 0x48, 0x8e, 0x71,
	0xc2, 0x63, 0x39, 0x86, 0x0b, 0x8f, 0xe5, 0x18, 0x6e, 0x3c, 0x96, 0x63, 0x88, 0xb2, 0x48, 0xcf,
	0x2c, 0xc9, 0x28, 0x4d, 0xd2, 0x4b, 0xce, 0xcf, 0xd5, 0x47, 0xf2, 0x2b, 0x12, 0x13, 0xe2, 0x19,
	0x8c, 0x70, 0x48, 0x62, 0x03, 0x4b, 0x18, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xa1, 0x1d, 0xa1,
	0xd1, 0x23, 0x01, 0x00, 0x00,
}
...
func (this *PublicKey_Ethsecp256K1) Compare(that interface{}) int {
	if that == nil {
		if this == nil {
			return 0
		}
	...
	that1, ok := that.(*PublicKey_Ethsecp256K1)
	if !ok {
		that2, ok := that.(PublicKey_Ethsecp256K1)
		if ok {
			that1 = &that2
		} else {
			return 1
	...
	if c := bytes.Compare(this.Ethsecp256K1, that1.Ethsecp256K1); c != 0 {
		return c
	}
	return 0
}
...
func (this *PublicKey_Ethsecp256K1) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}
	...
	if !bytes.Equal(this.Ethsecp256K1, that1.Ethsecp256K1) {
		return false
	}
	return true
}
...
func (m *PublicKey_Ethsecp256K1) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PublicKey_Ethsecp256K1) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Ethsecp256K1 != nil {
		i -= len(m.Ethsecp256K1)
		copy(dAtA[i:], m.Ethsecp256K1)
		i = encodeVarintKeys(dAtA, i, uint64(len(m.Ethsecp256K1)))
		i--
		dAtA[i] = 0x1a
	}
	return len(dAtA) - i, nil
...
func (m *PublicKey_Ethsecp256K1) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PublicKey) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Ethsecp256K1", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := make([]byte, postIndex-iNdEx)
			copy(v, dAtA[iNdEx:postIndex])
			m.Sum = &PublicKey_Ethsecp256K1{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
